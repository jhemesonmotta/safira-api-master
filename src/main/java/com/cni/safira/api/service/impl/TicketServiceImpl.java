...
import com.cni.safira.api.security.entity.ChangeStatus;
import com.cni.safira.api.security.entity.Ticket;
import com.cni.safira.api.service.TicketService;
...
//	private ChangeStatusRepository changeStatusRepository;
	...
	public Ticket createOrUpdate(Ticket ticket) {
		return null;//this.ticketRepository.save(ticket);
	}

	public Optional<Ticket> findById(String id) {
		return null;//this.ticketRepository.findById(id);
	}
...
//		this.ticketRepository.deleteById(id);
	...
	public Iterable<Ticket> findAll() {
		return null;//this.ticketRepository.findAll();
	}
	
	public Page<Ticket> findByCurrentUser(int page, int count, String userId) {
		Pageable pages = PageRequest.of(page, count);
		return null;//this.ticketRepository.findByUserIdOrderByDateDesc(pages,userId);
	}

	public ChangeStatus createChangeStatus(ChangeStatus changeStatus) {
		return null;//this.changeStatusRepository.save(changeStatus);
	}
	
	public Iterable<ChangeStatus> listChangeStatus(String ticketId) {
		return null;//this.changeStatusRepository.findByTicketIdOrderByDateChangeStatusDesc(ticketId);
	}
	
	public Page<Ticket> findByParameters(int page, int count,String title,String status,String priority) {
		Pageable pages = PageRequest.of(page, count);
		return null;//this.ticketRepository.
...
//				title,status,priority,userId,pages);
	...
	public Page<Ticket> findByNumber(int page, int count,Integer number){
		Pageable pages = PageRequest.of(page, count);
		return null;//this.ticketRepository.findByNumber(number, pages);
	}
